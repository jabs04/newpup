                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4" id="departmentContainer" style="display: none;">
                                {{ Form::label('department','Departement'.' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
                                <select class='form-control select2js' id='department' name="department">
                                    @php $userDepartment = $customerdata->department; @endphp
                                    @foreach($department as $dept)
                                    <option value="{{$dept->name}}" data-type="{{$dept->id}}"
                                        
                                        {{ $dept->name == $userDepartment ? 'selected' : '' }}>
                                        {{$dept->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-4" style="display: none;">
                                ...
                                {{ Form::password('password', ['class' => 'form-control', 'placeholder' => __('messages.password'), 'autocomplete' => 'new-password']) }}
                                <small class="help-block with-errors text-danger"></small>
                            </div>
                            @endif
