        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text  font-weight-bold">{{ !empty($data['depot_total_booking']) ? $data['depot_total_booking']: 0 }} </h4>
                            ...
                            <div class="card total-service-card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold">{{ !empty($data['depot_totaL_sp']) ? $data['depot_totaL_sp'] : 0 }}</h4>
                                            </div>
                                            <p class="mb-0 booking-text">Service Provider</p>
                                        </div>
                            ...
                            <div class="card total-provider-card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold">{{ !empty($data['depot_total_commission']) ? $data['depot_total_commission'] : 0 }}</h4> 
                    ...
                    <input type="hidden" value="{{ $data['depot_area'] }}" id="areadep">
                    <div class="col-lg-3 col-md-6">
                        <a  href="#">
                            <div class="card total-revenue">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold">{{ !empty($data['depot_total_sp_rev']) ? $data['depot_total_sp_rev'] : 0 }}</h4>
                                                <p class="mb-0 ml-3 text-danger font-weight-bold"></p>
                                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <h4 class=""><span class="text-primary">Wallet</span> | ₱ {{ isset($wallet->amount) ? $wallet->amount : "0.00"}}</h4>
                        </div>
                    </div>
                </div>
                <!-- start table -->
