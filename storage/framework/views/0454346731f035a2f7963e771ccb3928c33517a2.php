...
<?php $component->withAttributes([]); ?>
                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            <a href="<?php echo e(route('provider.create')); ?>" class="float-right mr-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> <?php echo e(__('messages.add_form_title',['form' => __('messages.provider')  ])); ?></a>
                            <?php endif; ?>
                        </div>
    ...
    <div class="card">
        ...
        <div class="row justify-content-between">
            <div>
                ...
                data--submit="<?php echo e(route('provider.bulk-action')); ?>"
                data-datatable="reload" 
                data-title="<?php echo e(__('provider',['form'=>  __('provider') ])); ?>"
                title="<?php echo e(__('provider',['form'=>  __('provider') ])); ?>"
    ...
    <script>
        ...
        <?php if($auth_user->user_type == "Depot"): ?>
            window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                  "type"   : "GET",
                  "url"    : '<?php echo e(route("provider.index_data_depo",["list_status"=>$list_status])); ?>',
                  "data"   : function( d ) {
                    d.search = {
                      value: $('.dt-search').val()
                    };
                ...
                columns: [
               ...
               
                    {
                        data: 'created_at',
                        name: 'created_at',
                        title: "<?php echo e(__('messages.joining_date')); ?>"
                    },
                    {
                      data:'providertype_id',
                      name:'providertype_id',
                      title:"<?php echo e(__('messages.providertype')); ?>"
                    },
                    {
                      data:'contact_number',
                      name:'contact_number',
                      title:"<?php echo e(__('messages.contact_number')); ?>"
                    },
                    {
                        data: 'status',
                        name: 'status',
        ...
        <?php else: ?>
            window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                  "type"   : "GET",
                  "url"    : '<?php echo e(route("provider.index_data",["list_status"=>$list_status])); ?>',
                  "data"   : function( d ) {
                    d.search = {
                      value: $('.dt-search').val()
                    };
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\newpup\resources\views/provider/index.blade.php ENDPATH**/ ?>