...
<head>
                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            <?php if($auth_user->can('document add')): ?>
                            <a href="<?php echo e(route('document.create')); ?>" class="float-right mr-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> <?php echo e(trans('messages.add_form_title',['form' => trans('messages.document')  ])); ?> </a>
                            <?php endif; ?>
                        </div>
    ...
    <div class="card">
        ...
        <div class="row justify-content-between">
            <div>
                <div class="col-md-12">
                  <form action="<?php echo e(route('document.bulk-action')); ?>" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                    <?php echo csrf_field(); ?>
                  <select name="action_type" class="form-control select2" id="quick-action-type" style="width:100%" disabled>
                      ...
                      <option value="change-featured"><?php echo e(__('messages.required')); ?></option>
                ...
                <div class="select-status d-none quick-action-featured" id="change-featured-action" style="width:100%">
                    <select name="is_required" class="form-control select2" id="is_required" >
                      <option value="1"><?php echo e(__('messages.yes')); ?></option>
                      <option value="0"><?php echo e(__('messages.no')); ?></option>
                    </select>
                </div>
                <button id="quick-action-apply" class="btn btn-primary" data-ajax="true"
                data--submit="<?php echo e(route('document.bulk-action')); ?>"
                data-datatable="reload" data-confirmation='true'
                data-title="<?php echo e(__('document',['form'=>  __('document') ])); ?>"
                title="<?php echo e(__('document',['form'=>  __('document') ])); ?>"
    ...
    <script>
        ...
        window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                  "type"   : "GET",
                  "url"    : '<?php echo e(route("document.index_data")); ?>',
                  "data"   : function( d ) {
                    d.search = {
                      value: $('.dt-search').val()
                    };
                ...
                columns: [
                    ...
                    },
                    {
                        data: 'is_required',
                        name: 'is_required',
                        title: "<?php echo e(__('messages.required')); ?>"
                    },
                    {
                        data: 'status',
                        name: 'status',
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\newpup\resources\views/document/index.blade.php ENDPATH**/ ?>