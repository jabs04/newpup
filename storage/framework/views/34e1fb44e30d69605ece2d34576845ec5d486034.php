                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold"><?php echo e(!empty($data['dashboard']['count_total_student']) ? $data['dashboard']['count_total_student'] : 0); ?></h4>
                            ...
                            <div class="card total-provider-card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold"><?php echo e(!empty($data['dashboard']['count_total_BSIT']) ? $data['dashboard']['count_total_BSIT'] : 0); ?></h4>
                                                <p class="mb-0 ml-3 text-danger font-weight-bold"></p>
                                            </div>
                            ...
                            <div class="card total-provider-card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold"><?php echo e(!empty($data['dashboard']['count_total_BSENT']) ? $data['dashboard']['count_total_BSENT'] : 0); ?></h4>
                                                <p class="mb-0 ml-3 text-danger font-weight-bold"></p>
                                            </div>
                            ...
                            <div class="card total-provider-card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold"><?php echo e(!empty($data['dashboard']['count_total_BTLED']) ? $data['dashboard']['count_total_BTLED'] : 0); ?></h4>
                                                <p class="mb-0 ml-3 text-danger font-weight-bold"></p>
                                            </div>
                ...
                <div class="card top-providers">
                    <div class="card-header d-flex justify-content-between gap-10">
                        <h4 class="font-weight-bold">Recent Student</h4>
                            <a href="<?php echo e(route('user.all','all')); ?>" class="btn-link btn-link-hover"><u><?php echo e(__('messages.view_all')); ?> </u></a>
                    </div>
                                    ...
                                    <div class="media-body ">
                                        <h5><span class="font-weight-bold"><?php echo e(!empty($provider->display_name) ? $provider->display_name : '-'); ?></span> </h5>
                                            <span class="common-list_rating d-flex gap-1">
                                                ...
                                                <?php echo e($provider->department); ?>
...
</script><?php /**PATH C:\xampp\htdocs\newpup\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>