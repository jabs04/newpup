                        ...
                        <li class="nav-item nav-icon dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="dropdownMenuButton">
                                ...
                                <li class="dropdown-item d-flex svg-icon border-top">
                                    ...
                                    <a href="<?php echo e(route('setting.index')); ?>"><?php echo e(__('messages.setting')); ?></a>
                                </li>
                                <li class="dropdown-item  d-flex svg-icon border-top">
...
</div><?php /**PATH C:\xampp\htdocs\old ays\resources\views/partials/_body_header.blade.php ENDPATH**/ ?>