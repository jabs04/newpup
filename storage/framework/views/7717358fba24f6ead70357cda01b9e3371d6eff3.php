...
<head>
                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            <h5 class="font-weight-bold"><?php echo e('All Neo List' ?? trans('All Neo List')); ?></h5>
                            <?php if($auth_user->can('user add')): ?>
                            <a href="<?php echo e(route('user.create_neo')); ?>" class="float-right mr-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> <?php echo e(__('messages.add_form_title',['form' => __('Neo')  ])); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
    ...
    <div class="card">
        ...
        <div class="row justify-content-between">
            <div>
                ...
                data--submit="<?php echo e(route('user.bulk-action')); ?>"
                data-datatable="reload" data-confirmation='true'
                data-title="<?php echo e(__('user',['form'=>  __('user') ])); ?>"
    ...
    <script>
        ...
        window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                  "type"   : "GET",
                  "url"    : '<?php echo e(route("user.index_neodata")); ?>',
                  "data"   : function( d ) {
                    d.search = {
                      value: $('.dt-search').val()
                    };
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\newpup\resources\views/customer/neo.blade.php ENDPATH**/ ?>