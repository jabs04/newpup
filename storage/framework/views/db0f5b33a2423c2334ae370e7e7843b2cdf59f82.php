                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            <thead class="table-color-heading">
                                                ...
                                                <th scope="col" class="text-center"><?php echo e(__('messages.status')); ?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <?php if(count($docs) > 0): ?>
                                                ...
                                                <td class="text-center fa-lg"><?php echo $doc['status']; ?></td>
                                                </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php else: ?>
                                                <tr>
                                                    <td colspan="4" class="text-center font-weight-bold"><?php echo e(__('messages.record_not_found')); ?></td>
                                                </tr>
                                            <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\newpup\resources\views/customer/view.blade.php ENDPATH**/ ?>